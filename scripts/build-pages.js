...
const T = {
  en: {
    ...
    'wholesale.para': 'Café owners and green buyers across Indonesia — we’ll send a curated sample kit of this season’s lots, with full traceability sheets and roast notes.',
    'wholesale.badge': 'Indonesia only',
    'wholesale.cardTitle': 'Let’s talk wholesale',
    'wholesale.cardDesc': 'Five 100g samples · traceability dossier · indicative pricing. No cost for qualified buyers.',
    ...
    'faq.shipInternational.a': 'No — right now we only serve Indonesia. Retail beans ship within Indonesia via Tokopedia and Shopee, and our wholesale and green coffee sample kits are currently available to buyers within Indonesia only.',
    ...
    'faq.wholesaleSupply.a': 'Yes — we work with café owners and green buyers within Indonesia through wholesale sample kits, sent with full traceability sheets and roast notes so you can evaluate a lot before committing to a larger order.',
    'faq.exportGreen.q': 'Do you sell green coffee to buyers outside Indonesia?',
    'faq.exportGreen.a': 'Not currently — our green coffee offer is limited to buyers within Indonesia for now, with indicative pricing provided once we understand your volume and lot preferences — message us on WhatsApp to start the conversation.',
    'faq.sampleKit.q': 'How do I request a wholesale sample kit?',
    'faq.sampleKit.a': 'Message us on WhatsApp or email us with your café or company name, and we’ll send a curated kit of five 100g samples from this season’s lots, along with a traceability dossier and indicative pricing — free for qualified buyers.',
  ...
  id: {
    ...
    'wholesale.para': 'Pemilik kafe dan pembeli green bean di seluruh Indonesia — kami kirimkan sample kit pilihan dari lot musim ini, lengkap dengan lembar traceability dan catatan roast.',
    'wholesale.badge': 'khusus dalam Indonesia',
    'wholesale.cardTitle': 'Yuk bicara soal grosir',
    'wholesale.cardDesc': 'Lima sample 100g · dokumen traceability · indikasi harga. Tanpa biaya untuk pembeli yang memenuhi kriteria.',
    ...
    'faq.shipInternational.a': 'Tidak — saat ini kami hanya melayani Indonesia. Biji kopi retail dikirim dalam Indonesia lewat Tokopedia dan Shopee, dan sample kit wholesale serta green bean kami saat ini hanya tersedia untuk pembeli di dalam Indonesia.',
    ...
    'faq.wholesaleSupply.a': 'Ya — kami bekerja sama dengan pemilik kafe dan pembeli green bean di dalam Indonesia lewat sample kit wholesale, dikirim lengkap dengan lembar traceability dan catatan roast supaya kamu bisa mengevaluasi satu lot sebelum melakukan pemesanan lebih besar.',
    'faq.exportGreen.q': 'Apakah kalian menjual green bean ke pembeli di luar Indonesia?',
    'faq.exportGreen.a': 'Belum saat ini — penawaran green bean kami masih terbatas untuk pembeli di dalam Indonesia, dengan indikasi harga setelah kami memahami volume dan preferensi lot-mu — chat kami di WhatsApp untuk memulai obrolannya.',
    'faq.sampleKit.q': 'Bagaimana cara meminta sample kit wholesale?',
    'faq.sampleKit.a': 'Chat kami di WhatsApp atau kirim email dengan nama kafe atau perusahaanmu, dan kami akan kirimkan kit berisi lima sample 100g dari lot musim ini, lengkap dengan dokumen traceability dan indikasi harga — tanpa biaya untuk pembeli yang memenuhi kriteria.',
